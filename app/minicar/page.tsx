      ...
      <main>
        <section className="relative pt-24 pb-32">
          <div className="absolute inset-0 z-0">
            ...
            <img src="https://www.autocar-location.com/wp-content/themes/autocar-theme/assets/images/minicar.jpg" alt="Minicar" className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gray-900/70"></div>
          </div>
          <div className="relative z-10 mx-auto max-w-6xl px-6">
            <nav className="text-xs text-gray-300 mb-6 flex items-center gap-2">
              <Link href="/" className="hover:text-white transition-colors">Accueil</Link>
              <span>»</span><span className="text-white font-medium">Minicar</span>
            </nav>
            ...
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4">Minicar</h1>
              <p className="text-lg text-gray-200 leading-relaxed mb-8">Le minicar est le compromis idéal entre le minibus agile et l'autocar de grande capacité.</p>
            </div>
            <div className="flex flex-wrap gap-3 mb-10">
              {["25 à 35 places", "Format intermédiaire", "Confort tourisme"].map((tag) => (
        ...
        <section className="mx-auto max-w-6xl px-6 py-20 grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2 space-y-10">
            <div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Quand choisir un minicar ?</h2>
              <div className="text-gray-600 space-y-4 leading-relaxed text-lg">
                <p>La location de minicar avec chauffeur s'adresse aux groupes intermédiaires qui veulent voyager ensemble sans passer sur un autocar standard. C'est un format très utile pour les excursions, classes, associations, équipes sportives, sorties CE et trajets régionaux avec un bon niveau de confort.</p>
                <p>Le minicar devient pertinent quand le groupe dépasse la capacité d'un minibus mais reste trop petit pour remplir un autocar. Il permet de garder une logistique simple, une bonne maniabilité et un coût ajusté lorsque le nombre de passagers tourne autour de 25 à 35 personnes.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { title: "Capacité", value: "25 à 35", desc: "Pour les groupes moyens qui veulent éviter deux véhicules." },
                { title: "Usage", value: "Polyvalent", desc: "Excursion, transfert, sortie scolaire, circuit court ou journée CE." },
                { title: "Confort", value: "Tourisme", desc: "Équipements variables selon modèle et distance prévue." }
              ].map((item, idx) => (
          ...
          <div className="rounded-3xl bg-white p-8 shadow-xl shadow-gray-200/50 border border-gray-100 sticky top-24">
            ...
            <div className="space-y-5 mb-8">
              {[
                { label: "Capacité", val: "25 à 35 places, format intermédiaire selon modèle" },
                { label: "Idéal pour", val: "excursions, scolaires, associations" },
                { label: "Trajets", val: "régional, tourisme, journée" },
                { label: "Bagages", val: "soutes adaptées selon véhicule" }
              ].map((spec, idx) => (
        ...
        <section className="bg-white py-20 border-y border-gray-100">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Pour quels trajets louer un minicar ?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { t: "Excursions et sorties CE", d: "Journées loisirs, visites culturelles, parcs, restaurants et retours organisés pour groupes moyens." },
                { t: "Scolaires et périscolaires", d: "Classes, centres de loisirs, clubs sportifs et groupes encadrés avec besoin de capacité mesurée." },
                { t: "Séminaires régionaux", d: "Transport d'équipe entre entreprise, hôtel, gare, lieu de réunion ou site de visite." },
                { t: "Circuits courts", d: "Itinéraires sur une journée ou un week-end avec plusieurs arrêts et horaires à respecter." }
              ].map((usage, idx) => (
        ...
        <section className="mx-auto max-w-6xl px-6 py-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="rounded-3xl bg-white p-8 border border-gray-100 shadow-sm">
            ...
            <ul className="space-y-4 text-sm text-gray-700 font-medium">
              {["Nombre de passagers, accompagnateurs et bagages.", "Programme de la journée, pauses et temps d'attente.", "Accessibilité du point de dépose pour un véhicule de gabarit intermédiaire.", "Équipements souhaités : micro, vidéo, climatisation ou soute."].map((li, i) => (
          ...
          <div className="rounded-3xl bg-white p-8 border border-gray-100 shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-6">Bon compromis capacité et maniabilité.</p>
            <ul className="space-y-4 text-sm text-gray-700 font-medium">
              {["Climatisation selon modèle", "Micro ou vidéo selon disponibilité", "Soute pour sacs et petits bagages", "Assise adaptée aux trajets régionaux"].map((li, i) => (
                <li key={i} className="flex items-start gap-3"><Check className="h-5 w-5 text-lime-500 shrink-0" /><span>{li}</span></li>
              ))}
            </ul>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          <div className="rounded-3xl bg-lime-400 p-8 md:p-12 grid grid-cols-1 md:grid-cols-3 gap-10 items-center shadow-xl shadow-lime-200">
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-900 font-bold">
              {[
                "Sortie scolaire de 30 élèves vers un musée régional.",
                "Excursion CE avec déjeuner et visite guidée.",
                "Équipe sportive vers un tournoi le week-end.",
                "Transfert de 28 invités entre gare, hôtel et lieu de réception."
              ].map((ex, i) => (
        ...
        <section className="mx-auto max-w-4xl px-6 py-20">
          ...
          <div className="space-y-4">
            {[
              { q: "Quelle capacité prévoir pour un minicar ?", a: "La capacité indicative est 25 à 35 places. Elle reste confirmée selon le modèle disponible, le nombre d'accompagnateurs et le volume de bagages." },
